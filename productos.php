...
<body>
    ...
    <form action="registroproducto.php" method="POST">
        ...
        <div class="mb-3"> 
            ...
            <option value="<?php echo $fila2["codigo"] ?>"><?php echo $fila2["nombref"]?></option>
            <?php } ?>
    ...
    <table class="table">
        ...
        <?php
          ...
          $consulta = "SELECT producto.codigo, producto.nombrep, producto.precio, fabricante.nombref FROM producto 
